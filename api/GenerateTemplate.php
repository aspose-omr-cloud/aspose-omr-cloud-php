...
class GenerateTemplate
{
    ...
    function cancelGenerateTemplate($id)
    {
        $postBody = null;

        // create path and map variables
        $path = "GenerateTemplate/CancelGenerateTemplate";
    ...
    function getGenerateTemplate($id)
    {
        $postBody = null;

        // create path and map variables
        $path = "GenerateTemplate/GetGenerateTemplate";
    ...
    function postGenerateTemplate($body)
    {
        ...
        // create path and map variables
        $path = "GenerateTemplate/PostGenerateTemplate";
